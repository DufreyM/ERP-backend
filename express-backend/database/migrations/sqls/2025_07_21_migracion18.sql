...
insert into calendario (usuario_id, titulo, estado_id, detalles, fecha, local_id, tipo_evento)
...
INSERT INTO calendario (usuario_id, visitador_id, titulo, estado_id, detalles, fecha, local_id, tipo_evento)
